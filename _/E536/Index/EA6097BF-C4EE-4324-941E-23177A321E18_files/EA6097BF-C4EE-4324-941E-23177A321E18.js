...
{
    document.write('<object id="id4" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab" width="300" height="316" style="height: 316px; left: 200px; position: absolute; top: 88px; width: 300px; z-index: 1; "><param name="src" value="EA6097BF-C4EE-4324-941E-23177A321E18_files/QTPlaceholder.mov" /><param name="qtsrc" value="Podcast.m4a" /><param name="controller" value="true" /><param name="autoplay" value="false" /><param name="scale" value="tofit" /><param name="volume" value="100" /><param name="loop" value="false" /><embed pluginspage="http://www.apple.com/quicktime/download/" type="video/quicktime" class="mov" width="300" height="316" src="EA6097BF-C4EE-4324-941E-23177A321E18_files/QTPlaceholder.mov" qtsrc="Podcast.m4a" controller="true" autoplay="false" scale="tofit" volume="100" loop="false"></embed></object>');
}
...
function onPageLoad()
{
    ...
    fixupIEPNG("id6", "EA6097BF-C4EE-4324-941E-23177A321E18_files/transparent.gif");
    return true;
}
